...
const Register = () => {
  ...
  return (
    <div className=" w-full h-screen commonClass flex items-center">
      <div className="w-[50%] h-full  p-10 bg-slate-100 ">
        <img
          ...
          <div className=" flex items-center gap-7">
            <div className="flex items-center gap-3">
              ...
              <p className=" flex flex-col  ">
                ...
                <span className="text-gray-400  text-sm">Account Details</span>
              </p>
            </div>
